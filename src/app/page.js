...
const animation = () =>{
  ...
  return (
    <div  ref={container} className='w-[100vw] overflow-x-hidden'>

      <div className='w-[80%] overflow-x-hidden text-[#44403c]'>
      <Header ref={stickyElement}/>
      <StickyCursor stickyElement={stickyElement}/>
      <div className={styles.heroContainer}>
        <div className={`w-[600px] absolute ${styles.circle1} circle1 -top-48 -left-48 md:h-[600px]  border-2 rounded-full`}></div>
        <div className='w-[600px] absolute circle2 -top-[450px] left-24 md:h-[600px]  border-2 rounded-full'></div>

      <div className='w-[100%] md:w-[80%]  h-[80%]   flex md:flex-row flex-col items-center '>
      ...
      <div className={`${styles.imageBorder} right-48 -bottom-72`}>
        ...
        alt='myImage'  
        src='/1.jpeg'
        className={`${styles.heroImage} z-0 heroImage bg-[url('/mybg.jpeg')] bg-cover h-[300px] md:h-[600px]`} />
        </div>
      </div>
      </div>
